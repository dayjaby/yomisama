...
class Ui_MainWindowReader(object):
    def setupUi(self, MainWindowReader):
        ...
        self.actionToggleSpanish = QtGui.QAction(MainWindowReader)
        self.actionToggleSpanish.setCheckable(True)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/img/icon_action_es.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionToggleSpanish.setIcon(icon16)
        self.actionToggleSpanish.setObjectName(_fromUtf8("actionToggleSpanish"))
        self.actionToggleFrench = QtGui.QAction(MainWindowReader)
        self.actionToggleFrench.setCheckable(True)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/img/icon_action_fr.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionToggleFrench.setIcon(icon17)
        self.actionToggleFrench.setObjectName(_fromUtf8("actionToggleFrench"))
    ...
    def retranslateUi(self, MainWindowReader):
        ...
        self.actionToggleSpanish.setText(_translate("MainWindowReader", "&Spanish", None))
        self.actionToggleSpanish.setToolTip(_translate("MainWindowReader", "Enable Spanish dictionary", None))
        self.actionToggleSpanish.setShortcut(_translate("MainWindowReader", "Ctrl+E", None))
        self.actionToggleFrench.setText(_translate("MainWindowReader", "&French", None))
        self.actionToggleFrench.setToolTip(_translate("MainWindowReader", "Enable French dictionary", None))
